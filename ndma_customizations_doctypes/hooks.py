...
app_include_js = [
	"/assets/ndma_customizations_doctypes/js/issue_quick_entry.js",
	"/assets/ndma_customizations_doctypes/js/manager_ndma_department_cards.js",
]
	...
	},
	{
		...
		"filters": [
			[
				"role",
				"in",
				["Department Manager", "DGM (Admin) - NDMA", "DGM (Operations) - NDMA"],
			],
			[
				"parent",
				"in",
